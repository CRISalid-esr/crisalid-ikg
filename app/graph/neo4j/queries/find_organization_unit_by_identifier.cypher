MATCH (o:OrganizationUnit)-[:HAS_IDENTIFIER]->(i:AgentIdentifier {type: $identifier_type, value: $identifier_value})
...
OPTIONAL MATCH (o)-[:HAS_IDENTIFIER]->(ai:AgentIdentifier)
...
RETURN o,
       ...
       collect(DISTINCT ai) AS identifiers,
