...
class AMQPStructureUpdatedEventMessageFactory(AMQPStructureEventMessageFactory):
    """Factory for structure updated events."""
    ...
    async def _build_payload(self) -> dict[str, Any]:
        ...
        return {"type": structure_type, "event": "updated", "fields": fields}
