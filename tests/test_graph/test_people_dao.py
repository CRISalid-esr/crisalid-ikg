...
async def test_create_person_with_two_names(
        person_with_two_names_pydantic_model: Person,
):
    """
...
async def test_create_person_with_two_last_names(
        person_with_two_last_names_pydantic_model: Person,
):
    """
    ...
    local_identifier = person_with_two_last_names_pydantic_model.get_identifier(
        PersonIdentifierType.LOCAL
    )
    person_from_db = await dao.find_by_identifier(
        local_identifier.type, local_identifier.value
