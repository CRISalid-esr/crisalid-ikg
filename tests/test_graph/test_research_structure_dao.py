...
async def test_switch_research_structure_identifier(
    ...
    basic_research_structure_pydantic_model.identifiers = [
        identifier for identifier in basic_research_structure_pydantic_model.identifiers
        if identifier.type != OrganizationIdentifierType.RNSR
    ]
    basic_research_structure_pydantic_model.identifiers.append(
    ...
    idref_identifier = basic_research_structure_pydantic_model.get_identifier(
