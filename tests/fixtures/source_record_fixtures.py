...
async def fixture_scanr_thesis_source_record_pydantic_model(_base_path) -> Person:
    """
    ...
    return _source_record_from_json_data(
        _source_record_json_data_from_file(_base_path, "scanr_thesis_source_record"))
...
async def fixture_idref_thesis_source_record_pydantic_model(_base_path) -> Person:
    """
    Create a basic source record pydantic model from IdRef data
    :return: basic source record pydantic model from IdRef data
    """
    return _source_record_from_json_data(
        _source_record_json_data_from_file(_base_path, "idref_thesis_source_record"))
