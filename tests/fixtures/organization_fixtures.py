...
@pytest_asyncio.fixture(
    name="research_str_a_with_nam_acr_desc_str_ror_ital_desc_name_added_pydantic_model")
async def fixture_research_str_a_with_nam_acr_desc_str_ror_ital_desc_name_added_pydantic_model(
        research_str_a_with_nam_acr_desc_str_ror_ital_desc_name_added_json_data
) -> ResearchStructure:
    """
    Create a basic structure pydantic model
    :return: basic structure pydantic model
...
@pytest_asyncio.fixture(
    name="research_str_a_with_nam_acr_desc_str_ror_ital_desc_name_added_json_data")
async def fixture_research_str_a_with_nam_acr_desc_str_ror_ital_desc_name_added_json_data(
        _base_path) -> dict:
    """
    Create a basic structure json data
    :return: basic structure json data
    ...
    return _organization_json_data_from_file(
        _base_path,
        "research_str_a_with_nam_acr_desc_str_ror_ital_desc_name_added")
