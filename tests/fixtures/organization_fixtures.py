...
from tests.fixtures.common import _research_unit_from_json_data, \
    _organization_json_data_from_file, _organization_unit_json_data_from_file, \
    _organization_unit_from_json_data
...
async def fixture_persisted_research_unit_a_pydantic_model(
    ...
    dao = factory.get_dao(ResearchUnit)
...
async def fixture_research_unit_a_pydantic_model(
        research_unit_a_json_data) -> ResearchUnit:
    """
    Create a basic structure pydantic model
    :return: basic structure pydantic model
    """
    return _research_unit_from_json_data(research_unit_a_json_data)
...
async def fixture_research_unit_a_json_data(_base_path) -> dict:
    ...
    """
    return _organization_json_data_from_file(_base_path, "research_unit_a")


@pytest_asyncio.fixture(name="research_unit_a_with_updated_name_pydantic_model")
async def fixture_research_unit_a_with_updated_name_pydantic_model(
        research_unit_a_with_updated_name_json_data) -> ResearchUnit:
    """
    Create a basic structure pydantic model
    :return: basic structure pydantic model
    """
    return _research_unit_from_json_data(research_unit_a_with_updated_name_json_data)


@pytest_asyncio.fixture(name="research_unit_a_with_updated_name_json_data")
async def fixture_research_unit_a_with_updated_name_json_data(_base_path) -> dict:
    """
    Create a basic structure json data
    :return: basic structure json data
    """
    return _organization_json_data_from_file(_base_path, "research_unit_a_with_updated_name")
...
async def fixture_research_unit_a_with_nam_acr_desc_str_ror_ital_desc_name_added_pydantic_model(
    ...
    :return: basic structure pydantic model
    """
    return _research_unit_from_json_data(
        research_unit_a_with_nam_acr_desc_str_ror_ital_desc_name_added_json_data)
...
async def fixture_persisted_research_unit_b_pydantic_model(
        research_unit_b_pydantic_model) -> ResearchUnit:
    """
    Create a basic persisted research structure pydantic model
    :return: basic persisted research structure pydantic model
    """
...
async def fixture_research_unit_b_pydantic_model(
        research_unit_b_json_data) -> ResearchUnit:
    """
    Create a basic structure pydantic model
    :return: basic structure pydantic model
    """
    return _research_unit_from_json_data(research_unit_b_json_data)
...
async def fixture_research_unit_with_duplicate_identifiers_json_data(_base_path) -> dict:
    ...
    """
    return _organization_json_data_from_file(
        _base_path, "research_unit_with_duplicate_identifiers")
...
async def fixture_research_unit_b_without_name_json_data(_base_path) -> dict:
    ...
    """
    return _organization_json_data_from_file(
        _base_path, "research_unit_b_without_name"
    )
