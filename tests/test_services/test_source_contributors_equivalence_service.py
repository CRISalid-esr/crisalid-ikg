...
async def test_create_source_records_with_shared_contributors(
    ...
    # and we add im an identifier of type openalex and value https://openalex.org/A5088876922
...
async def test_two_equivalent_records_with_the_same_contributors(
    ...
    assert ((await person_dao.get_person_uid_by_source_person_uid(
        'openalex-https://openalex.org/A5065084602', external=False)) ==
    ...
    external_contribution_1 = next(
        (contribution for contribution in external_contributions if
         contribution.contributor.uid == 'openalex-https://openalex.org/A5088876922'),
        None)
    ...
    assert external_contribution_1.contributor.uid == 'openalex-https://openalex.org/A5088876922'
    ...
    external_contribution_2 = next(
        (contribution for contribution in external_contributions if
         contribution.contributor.uid == 'openalex-https://openalex.org/A5019602694'),
        None)
    ...
    assert external_contribution_2.contributor.uid == 'openalex-https://openalex.org/A5019602694'
    ...
    assert (await source_person_dao.get_equivalents(
        'scanr-idref888888888')) == ['openalex-https://openalex.org/A5065084602']
    assert (await source_person_dao.get_equivalents(
        'openalex-https://openalex.org/A5065084602')) == ['scanr-idref888888888']
    assert (await source_person_dao.get_equivalents(
        'openalex-https://openalex.org/A5019602694')) == ['scanr-idref999999999']
    assert (await source_person_dao.get_equivalents(
        'scanr-idref999999999')) == ['openalex-https://openalex.org/A5019602694']
    ...
    external_person_1_uid_1 = await person_dao.get_person_uid_by_source_person_uid(
        'openalex-https://openalex.org/A5088876922', external=True)
    ...
    external_person_2_uid_1 = await person_dao.get_person_uid_by_source_person_uid(
        'openalex-https://openalex.org/A5019602694', external=True)
