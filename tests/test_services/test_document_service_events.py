...
async def test_signal_document_created(
    ...
    expected_sent_message_payload_fields = {'abstracts': [], 'contributions': [{'contributor': {
        ...
        'display_name': 'M.-A. Miville-Deschênes',
        'external': True, 'identifiers': [],
        'memberships': [], 'names': [], 'uid': 'hal-578950'},
        'rank': None,
        'roles': ['LocContributionRole.AUTHOR']}, {
        'contributor': {
        ...
        {'contributor': {'display_name': 'L F J',
                         'external': True, 'identifiers': [],
                         'memberships': [], 'names': [],
         ...
         'roles': ['LocContributionRole.AUTHOR']}, {
            ...
            'roles': [
                'LocContributionRole.AUTHOR']},
        {'contributor': {'display_name': 'Garcia, Raymond',
